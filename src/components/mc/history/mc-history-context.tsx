'use client';
import MCToggleHistoryButton from "@/components/mc/history/mc-toggle-history-button";
import { useState } from 'react';
import MCHistory from "./mc-history";

export default function MCHistoryContext() {
  const [showHistory, setShowHistory] = useState(false);

  return (
    <>
      <MCHistory showHistory={showHistory} />
